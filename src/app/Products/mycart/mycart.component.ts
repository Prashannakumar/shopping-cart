...
export class MycartComponent implements OnInit {
  ...
  updateCart(cartdId:number, cartQty:number, pdtPrice:number)
  {
    this.pdtSer.updateMyCartItems(cartdId, cartQty, pdtPrice).subscribe((data:string)=>{
